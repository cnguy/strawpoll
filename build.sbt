...
git.remoteRepo := "git@github.com:cnguy/strawpoll.git"

micrositeGithubOwner := "cnguy"

micrositeGithubRepo := "strawpoll"

micrositeName := "strawpoll"

micrositeDescription := "Small strawpoll clone"

micrositeBaseUrl := "strawpoll"
